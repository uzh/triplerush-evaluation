...
object DictionaryEncoderWithBaseRdfType extends KrakenExecutableRdfType with Serializable {
//  override def executionHost = local
  run(BaseEncoderRdfType.encode(args(0)) _)
}

case object BaseEncoderRdfType extends Serializable {
